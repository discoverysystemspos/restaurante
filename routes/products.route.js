...
// CONTROLLER
const { getProducts, createProduct, updateProduct, deleteProduct, oneProduct, codeProduct, departmentProduct } = require('../controllers/products.controller');
...
=========================================================================*/
router.get('/department/:department', validarJWT, departmentProduct);
/** =====================================================================
 *  DEPARTMENT GET PRODUCT
=========================================================================*/
 ...
 *  GET CODE PRODUCT
=========================================================================*/
router.get('/code/:code', validarJWT, codeProduct);
/** =====================================================================
 *  GET CODE PRODUCT
=========================================================================*/
